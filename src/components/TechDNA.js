...
const TechDNA = () => {
  ...
  // Radius determines horizontal spread. Must be smaller on mobile to avoid overflow.
  const radius = isSmallMobile ? 65 : (isMobile ? 90 : 200);
  const verticalSpacing = isMobile ? 45 : 60;
